...
_G.packer_plugins = {
  colorschemes = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["coq.artifacts"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/coq.artifacts",
  ...
  ["coq.thirdparty"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/coq.thirdparty",
    url = "https://github.com/ms-jpq/coq.thirdparty"
  },
  coq_nvim = {
    after = { "coq.artifacts", "coq.thirdparty" },
    config = { "\27LJ\2\n6\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\ruser.coq\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/coq_nvim",
  ...
  ["lsp_signature.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/lsp_signature.nvim",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
    url = "https://github.com/williamboman/nvim-lsp-installer"
  },
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "lsp_signature.nvim" },
    config = { "\27LJ\2\n6\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\ruser.lsp\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["vim-monokai-tasty"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/vim-monokai-tasty",
